        ...
        <form id="sell" enctype="multipart/form-data">
            ...
            <div class="price-box">
                ...
                <div class="free-gift-container">
                    <input type="checkbox" id="free-gift" value="free-gift" style="display:none;">
...
<script src="${pageContext.request.contextPath}/resources/js/write_js_backup.js"></script>
